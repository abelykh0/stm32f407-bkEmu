...
.Ltext0:
	...
	.section	.text.ev_init,"ax",%progbits
	.align	1
	.global	ev_init
	.syntax unified
	.thumb
...
ev_init:
.LFB3:
	.file 1 "../Main/Emulator/pdp/service.c"
	.loc 1 31 0
	.cfi_startproc
...
.LFE3:
	...
	.section	.text.ev_register,"ax",%progbits
	.align	1
	.global	ev_register
	.syntax unified
	.thumb
...
.L10:
	...
	.cfi_endproc
.LFE4:
	.size	ev_register, .-ev_register
	.global	__aeabi_dcmple
	.section	.text.ev_fire,"ax",%progbits
	.align	1
	.global	ev_fire
	.syntax unified
	.thumb
...
.L28:
	...
	.cfi_endproc
.LFE5:
	.size	ev_fire, .-ev_fire
	.section	.text.service,"ax",%progbits
	.align	1
	.global	service
	.syntax unified
	.thumb
...
.LFE8:
	...
	.comm	events,32,8
	.global	earliest
	.global	pending_interrupts
	.global	in_wait_instr
	.bss
	.align	3
	.set	.LANCHOR0,. + 0
	.type	pending_interrupts, %object
	.size	pending_interrupts, 4
pending_interrupts:
	.space	4
	.space	4
	.type	earliest, %object
	.size	earliest, 8
earliest:
	.space	8
	.type	in_wait_instr, %object
	.size	in_wait_instr, 1
in_wait_instr:
	.space	1
	.text
.Letext0:
...
.LASF1141:
	.ascii	"../Main/Emulator/pdp/service.c\000"
.LASF8:
