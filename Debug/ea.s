...
.Ltext0:
	...
	.section	.text.load_ea,"ax",%progbits
	.align	1
	.global	load_ea
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	load_ea, %function
load_ea:
.LFB3:
	.file 1 "../Main/Emulator/pdp/ea.c"
	.loc 1 44 0
	.cfi_startproc
...
.LFE5:
	.size	push, .-push
	.section	.text.loadb_dst,"ax",%progbits
	.align	1
	.global	loadb_dst
	.syntax unified
	.thumb
...
.L32:
	...
	.cfi_endproc
.LFE6:
	.size	loadb_dst, .-loadb_dst
	.section	.text.loadb_src,"ax",%progbits
	.align	1
	.global	loadb_src
	.syntax unified
	.thumb
...
.L48:
	...
	.cfi_endproc
.LFE7:
	.size	loadb_src, .-loadb_src
	.section	.text.storeb_dst,"ax",%progbits
	.align	1
	.global	storeb_dst
	.syntax unified
	.thumb
...
.L64:
	...
	.cfi_endproc
.LFE8:
	.size	storeb_dst, .-storeb_dst
	.section	.text.storeb_dst_2,"ax",%progbits
	.align	1
	.global	storeb_dst_2
	.syntax unified
	.thumb
...
.LVL113:
	...
	.cfi_endproc
.LFE9:
	.size	storeb_dst_2, .-storeb_dst_2
	.section	.text.load_src,"ax",%progbits
	.align	1
	.global	load_src
	.syntax unified
	.thumb
...
.L81:
	...
	.cfi_endproc
.LFE10:
	.size	load_src, .-load_src
	.section	.text.store_dst,"ax",%progbits
	.align	1
	.global	store_dst
	.syntax unified
	.thumb
...
.L94:
	...
	.cfi_endproc
.LFE11:
	.size	store_dst, .-store_dst
	.section	.text.load_dst,"ax",%progbits
	.align	1
	.global	load_dst
	.syntax unified
	.thumb
...
.L107:
	...
	.cfi_endproc
.LFE12:
	.size	load_dst, .-load_dst
	.section	.text.store_dst_2,"ax",%progbits
	.align	1
	.global	store_dst_2
	.syntax unified
	.thumb
...
.LASF1137:
	.ascii	"../Main/Emulator/pdp/ea.c\000"
.LASF487:
