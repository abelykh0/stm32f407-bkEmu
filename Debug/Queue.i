...
int QueuePut(int32_t element)
{
    if (QueueIn == ((QueueOut - 1 + (6 + 1)) % (6 + 1)))
    {
        return -1;
    }

    Queue[QueueIn] = element;
    QueueIn = (QueueIn + 1) % (6 + 1);
