...
.Ltext0:
	...
	.section	.text.FATFS_LinkDriverEx,"ax",%progbits
	.align	1
	.global	FATFS_LinkDriverEx
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	FATFS_LinkDriverEx, %function
FATFS_LinkDriverEx:
.LFB0:
	.file 1 "../Main/sdCard/ff_gen_drv.c"
	.loc 1 28 0
	.cfi_startproc
...
.L8:
	...
	.cfi_endproc
.LFE0:
	.size	FATFS_LinkDriverEx, .-FATFS_LinkDriverEx
	.section	.text.FATFS_LinkDriver,"ax",%progbits
	.align	1
	.global	FATFS_LinkDriver
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	FATFS_LinkDriver, %function
FATFS_LinkDriver:
.LFB1:
	.loc 1 57 0
	.cfi_startproc
...
.LVL12:
	...
	.cfi_endproc
.LFE1:
	.size	FATFS_LinkDriver, .-FATFS_LinkDriver
	.section	.text.FATFS_UnLinkDriverEx,"ax",%progbits
	.align	1
	.global	FATFS_UnLinkDriverEx
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	FATFS_UnLinkDriverEx, %function
...
.L16:
	...
	.cfi_endproc
.LFE2:
	.size	FATFS_UnLinkDriverEx, .-FATFS_UnLinkDriverEx
	.section	.text.FATFS_UnLinkDriver,"ax",%progbits
	.align	1
	.global	FATFS_UnLinkDriver
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	FATFS_UnLinkDriver, %function
FATFS_UnLinkDriver:
.LFB3:
	.loc 1 95 0
	.cfi_startproc
...
.LVL23:
	...
	.cfi_endproc
.LFE3:
	.size	FATFS_UnLinkDriver, .-FATFS_UnLinkDriver
	.section	.text.FATFS_GetAttachedDriversNbr,"ax",%progbits
	.align	1
	.global	FATFS_GetAttachedDriversNbr
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	FATFS_GetAttachedDriversNbr, %function
...
.L21:
	...
	.cfi_endproc
.LFE4:
	.size	FATFS_GetAttachedDriversNbr, .-FATFS_GetAttachedDriversNbr
	.global	disk
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
...
.Ldebug_macro0:
	...
	.uleb128 0x17
	.4byte	.LASF592
	.file 12 "C:/Projects/stm32f407-bkEmu/Main/sdCard/ffconf.h"
	.byte	0x3
	.uleb128 0x1d
	.uleb128 0xc
	.byte	0x7
...
.Ldebug_macro7:
	...
	.4byte	.LASF629
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.ff.h.43.76482eecf8bc3b7c7e43938b9f7aa47e,comdat
.Ldebug_macro8:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF409:
	.ascii	"__arm__ 1\000"
.LASF730:
	.ascii	"FATFS_GetAttachedDriversNbr\000"
.LASF177:
...
.LASF722:
	.ascii	"FATFS_UnLinkDriverEx\000"
.LASF243:
...
.LASF727:
	.ascii	"../Main/sdCard/ff_gen_drv.c\000"
.LASF654:
