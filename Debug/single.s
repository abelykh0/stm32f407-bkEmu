...
adc:
.LFB3:
	.file 1 "../Main/Emulator/pdp/single.c"
	.loc 1 40 0
	.cfi_startproc
...
.LFE13:
	.size	sbc, .-sbc
	.section	.text.swabi,"ax",%progbits
	.align	1
	.global	swabi
	.syntax unified
	.thumb
...
.L176:
	...
	tst	r1, #128
	bne	.L185
	.loc 1 506 0 is_stmt 0 discriminator 2
	ldrb	r3, [r4, #16]	@ zero_extendqisi2
	bic	r3, r3, #8
	strb	r3, [r4, #16]
.L178:
...
.LASF1145:
	.ascii	"../Main/Emulator/pdp/single.c\000"
.LASF248:
